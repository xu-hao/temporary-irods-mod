// =-=-=-=-=-=-=-
// irods includes
#include "irods_generic_object.hpp"
...
// =-=-=-=-=-=-=-
// public - ctor
    generic_object::generic_object(const std::string &_type) : type_(_type) {
...
// public - assignment operator
    generic_object& generic_object::operator=(
...
// public - equivalence operator
    bool generic_object::operator==(
        const generic_object& ) const {
        return false;
...
// public - get rule engine kvp
    error generic_object::get_re_vars(
        rule_engine_vars_t& ) {
